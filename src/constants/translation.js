export const T = {
  en: {
    nav: { emergency: "Emergency Course", packages: "Driving Packages", locations: "Locations", about: "About Us", bookTrial: "Book Trial Lesson", calculator: "Lesson Calculator" },
    banner: ["🏆 45,824 graduates", "⚡ Start tomorrow", "🎯 98% pass rate", "🎁 Up to €400 off"],
    hero: {
  ...
  nl: {
    nav: { emergency: "Spoedcursus", packages: "Rijpakketten", locations: "Locaties", about: "Over Ons", bookTrial: "Proefles Boeken", calculator: "Leskostencalculator" },
    banner: ["🏆 45.824 geslaagden", "⚡ Morgen beginnen", "🎯 98% slagingspercentage", "🎁 Tot €400 korting"],
    hero: {
    ...
    card: {
      ...
      zip: "Postcode",
      address: "Straatnaam",
      apartment: "Appartement / huisnummer",
      ...
      note: "Vul uw gegevens in om tijdsloten te zien.",
      successTitle: "Gelukt! 🎉",
